...
[bibtex](https://github.com/latex-lsp/tree-sitter-bibtex) |  | `HFI ` |  |  | @theHamsta, @clason
...
[c](https://github.com/tree-sitter/tree-sitter-c) |  | `HFIJ` |  |  | @amaanq
...
[comment](https://github.com/stsewd/tree-sitter-comment) |  | `H   ` |  |  | @stsewd
...
[julia](https://github.com/tree-sitter/tree-sitter-julia) |  | `HFIJ` |  |  | @theHamsta
...
[latex](https://github.com/latex-lsp/tree-sitter-latex) |  | `HF J` |  |  | @theHamsta, @clason
...
[markdown](https://github.com/MDeiml/tree-sitter-markdown)[^markdown] |  | `HF J` |  |  | @MDeiml
[markdown_inline](https://github.com/MDeiml/tree-sitter-markdown)[^markdown_inline] |  | `H  J` |  |  | @MDeiml
...
[query](https://github.com/nvim-treesitter/tree-sitter-query)[^query] |  | `HFIJ` |  |  | @steelsojka
...
[sql](https://github.com/derekstride/tree-sitter-sql) |  | `H  J` |  |  | @derekstride
...
[vim](https://github.com/neovim/tree-sitter-vim) |  | `HF J` |  |  | @clason
[vimdoc](https://github.com/neovim/tree-sitter-vimdoc) |  | `H  J` |  |  | @clason
